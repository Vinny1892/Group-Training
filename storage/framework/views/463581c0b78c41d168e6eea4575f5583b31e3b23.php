            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse navbar-inverse-collapse navbar-loggedout js-header-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right loggedout-menu hidden-xs hidden-sm">
                        <?php if(!Auth::check()): ?>
                            <li>
                                <a href="<?php echo e(route('register')); ?>" role="button" title="Cadastre-se"
                                   class="">Cadastre-se</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('login')); ?>" role="button" title="Entrar " class="">Entrar </a>
                            </li>
                        <?php else: ?>
                            <li>
                                <p class="navbar-btn">
                                    <a href="<?php echo e(route('painel')); ?>" role="button" title="Publique um projeto"
            ...
            <div class="container">
                ...
                <ul class="list-unstyled list-inline">
                    <?php $__currentLoopData = $patrocinadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patrocinador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <img src="<?php echo e(asset('img/'.$patrocinador.'.png')); ?>" alt="<?= $patrocinador ?>">
                        </li>
...
<?php echo $__env->make('home.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/home/homePage.blade.php ENDPATH**/ ?>